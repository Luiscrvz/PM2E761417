...
public class MainActivity extends AppCompatActivity {
    ...
    private void AddUser() {
        try {
            ...
            Long result = db.insert(Usuarios.Tabla, Usuarios.id, valores); // Cambiado Usuarios.id a null
            ...
            exception.printStackTrace(); // Imprime la excepción en el registro
            Toast.makeText(this, "Error al ingresar el usuario", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.example.pm1_e1_0031_0101.fileprovider",
                        photoFile);
